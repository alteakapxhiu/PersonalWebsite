        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#Certifications" className={activeLink === 'Certifications' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('Certefications')}>Certifications</Nav.Link>
            </Nav>
